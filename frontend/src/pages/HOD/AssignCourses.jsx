...
const AssignCourses = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch department courses, lecturers, and assignments data
      const response = await api.get('/hod/assign-courses/');
      const data = response.data;
      
      setCourses(data.courses || []);
      setLecturers(data.lecturers || []);
      
      // For assignments, we might need a separate endpoint or calculate from course assignments
      // For now, keep the existing logic but it may need adjustment
