    ...
    <div className="App">
      ...
      <main>
        <Routes>
              ...
              {/* Protected Routes */}
              <Route path="/admin/dashboard" element={<ProtectedRoute role="University ICT Admin"><UniversityAdminDashboard /></ProtectedRoute>} />
              <Route path="/admin/faculties" element={<ProtectedRoute role="University ICT Admin"><Faculties /></ProtectedRoute>} />
              <Route path="/admin/departments" element={<ProtectedRoute role="University ICT Admin"><Departments /></ProtectedRoute>} />
              <Route path="/admin/programs" element={<ProtectedRoute role="University ICT Admin"><Programs /></ProtectedRoute>} />
              <Route path="/admin/courses" element={<ProtectedRoute role="University ICT Admin"><Courses /></ProtectedRoute>} />
              <Route path="/admin/upload-students" element={<ProtectedRoute role="University ICT Admin"><UploadStudents /></ProtectedRoute>} />
              <Route path="/admin/upload-lecturers" element={<ProtectedRoute role="University ICT Admin"><UploadLecturers /></ProtectedRoute>} />
              <Route path="/admin/sessions" element={<ProtectedRoute role="University ICT Admin"><AcademicSessions /></ProtectedRoute>} />
